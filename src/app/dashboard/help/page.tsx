...
const translations = {
  ...
  ar: {
    ...
    requestLoanQ: 'كيف أطلب سلفة؟',
    requestLoanA: 'انتقل إلى الخدمة الذاتية > طلب سلفة، أدخل مبلغ السلفة وعدد الأقساط وتاريخ القسط الأول، ثم أرسل الطلب.',
    ...
    postponeInstallmentQ: 'كيف أؤجل قسط سلفة؟',
    ...
    viewLoanInstallmentsQ: 'كيف أطلع على أقساط السلف الخاصة بي؟',
    viewLoanInstallmentsA: 'انتقل إلى إدارة الموظفين > أقساط السلف لعرض جميع أقساط السلف وتواريخ الاستحقاق وحالة الدفع والتواريخ المدفوعة.',
    // Management FAQs
