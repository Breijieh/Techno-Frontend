...
const translations = {
  ...
  ar: {
    ...
    faq: 'الأسئلة الشائعة',
    // Employee FAQs
    checkInOutQ: 'كيف أقوم بتسجيل الدخول/الخروج؟',
    checkInOutA: 'انتقل إلى الخدمة الذاتية > تسجيل الدخول/الخروج، انقر على زر "تسجيل الدخول" أو "تسجيل الخروج". تأكد من تفعيل خدمات الموقع للتحقق من GPS.',
