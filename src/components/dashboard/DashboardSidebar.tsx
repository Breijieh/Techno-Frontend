  ...
  const baseChannelItems: MenuItem[] = useMemo(() => [
    ...
    },
    {
      ...
      submenu: [
        ...
        { label: 'تقرير أقساط السلف', icon: <ReceiptLong /> },
