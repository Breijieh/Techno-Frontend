...
export const MENU_LABEL_ROUTE_MAP: Record<string, string> = {
  ...
  'تقرير أقساط السلف': '/dashboard/reports/loan-installments',
  ...
  'طلب سلفة': '/dashboard/self-service/loan',
